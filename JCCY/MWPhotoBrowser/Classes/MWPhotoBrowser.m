...
- (YXProgressHUD *)progressHUD {
    if (!_progressHUD) {
        _progressHUD = [[YXProgressHUD alloc] initWithView:self.view];
...
- (void)showProgressHUDWithMessage:(NSString *)message {
    ...
    self.progressHUD.mode = YXProgressHUDModeIndeterminate;
...
- (void)showProgressHUDCompleteMessage:(NSString *)message {
    if (message) {
        ...
        self.progressHUD.labelText = message;
        self.progressHUD.mode = YXProgressHUDModeCustomView;
