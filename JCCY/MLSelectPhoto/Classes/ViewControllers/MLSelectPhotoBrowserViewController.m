...
- (UIButton *)doneBtn{
    if (!_doneBtn) {
        ...
        [rightBtn setTitleColor:[UIColor colorFromHexRGB:@"4d7fff"] forState:UIControlStateNormal];
...
- (UIButton *)deleleBtn{
    if (!_deleleBtn) {
        ...
        deleleBtn.titleLabel.font = SystemFont(15);
...
- (void) setupToorBar{
    ...
    toorBar.barTintColor = DefaultNavbarTintColor;
