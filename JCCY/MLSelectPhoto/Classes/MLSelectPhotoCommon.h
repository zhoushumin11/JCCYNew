...
// Navigation Color
#define DefaultNavbarTintColor UIColorFromRGB(0xf2f2f2)
#define DefaultNavTintColor UIColorFromRGB(0x666666)
#define DefaultNavTitleColor UIColorFromRGB(0x131315)
